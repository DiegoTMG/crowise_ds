...
const ScoutingPlan: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
...
<path d="M13 13H7V15H13V13Z" fill="currentColor"/>
...
ScoutingPlan.displayName = "ScoutingPlan";
export default ScoutingPlan;

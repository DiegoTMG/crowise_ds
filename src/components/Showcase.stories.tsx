...
const componentCards: CardItem[] = [
  // Primary
  { name: "PrimaryRound", category: "buttons", subcategory: "Primary", description: "Standard primary rounded button", render: () => <PrimaryRoundAtom forcedState="default" label="Button" /> },
  { name: "PrimaryIconOnlyCircle", category: "buttons", subcategory: "Primary", description: "Icon-only circular primary button", render: () => <IconOnlyCircleAtom forcedState="default" /> },
  { name: "PrimaryIconOnlySquare", category: "buttons", subcategory: "Primary", description: "Icon-only square primary button", render: () => <IconOnlySquareAtom forcedState="default" /> },
  { name: "PrimarySplitRound", category: "buttons", subcategory: "Primary", description: "Split action primary rounded button", render: () => <PrimarySplitRoundAtom primaryForcedState="default" menuForcedState="default" label="Button" /> },
  // Secondary
  { name: "SecondaryStandardRound", category: "buttons", subcategory: "Secondary", description: "Standard secondary rounded button", render: () => <SecondaryRoundAtom forcedState="default" label="Button" /> },
  { name: "SecondaryStandardSquare", category: "buttons", subcategory: "Secondary", description: "Standard secondary square button", render: () => <SecondarySquareAtom forcedState="default" label="Button" /> },
  { name: "SecondaryIconOnlyCircle", category: "buttons", subcategory: "Secondary", description: "Icon-only circular secondary button", render: () => <SecondaryIconOnlyCircleAtom forcedState="default" /> },
  { name: "SecondaryIconOnlySquare", category: "buttons", subcategory: "Secondary", description: "Icon-only square secondary button", render: () => <SecondaryIconOnlySquareAtom forcedState="default" /> },
  { name: "SecondarySplitSquare", category: "buttons", subcategory: "Secondary", description: "Split action secondary square button", render: () => <SecondarySplitSquareAtom primaryForcedState="default" menuForcedState="default" label="Button" /> },
  // Tertiary
  { name: "TertiaryStandardRound", category: "buttons", subcategory: "Tertiary", description: "Standard tertiary rounded button", render: () => <TertiaryStandardRoundAtom forcedState="default" label="Button" /> },
  { name: "TertiaryStandardSquare", category: "buttons", subcategory: "Tertiary", description: "Standard tertiary square button", render: () => <TertiaryStandardSquareAtom forcedState="default" label="Button" /> },
  { name: "TertiaryIconOnlyRound", category: "buttons", subcategory: "Tertiary", description: "Icon-only rounded tertiary button", render: () => <TertiaryIconOnlyRoundAtom forcedState="default" /> },
  { name: "TertiaryIconOnlySquare", category: "buttons", subcategory: "Tertiary", description: "Icon-only square tertiary button", render: () => <TertiaryIconOnlySquareAtom forcedState="default" /> },
  { name: "TertiarySplitSquare", category: "buttons", subcategory: "Tertiary", description: "Split action tertiary square button", render: () => <TertiarySplitSquareAtom primaryForcedState="default" menuForcedState="default" label="Button" /> },
  { name: "TertiaryAddAnother", category: "buttons", subcategory: "Tertiary", description: "Add another item tertiary button", render: () => <TertiaryAddAnotherAtom forcedState="default" label="Button" /> },
  { name: "TertiaryTextLink", category: "buttons", subcategory: "Tertiary", description: "Text link style tertiary button", render: () => <TertiaryTextLinkAtom forcedState="default" label="Button" /> },
  { name: "TertiaryVertical", category: "buttons", subcategory: "Tertiary", description: "Vertically stacked tertiary button", render: () => <TertiaryVerticalAtom forcedState="default" label="Button" /> },
  // Ghost & Destructive
  { name: "GhostStandard", category: "buttons", subcategory: "Ghost", description: "Ghost standard button", render: () => <GhostStandard forcedState="default" label="Button" /> },
  { name: "DestructiveStandard", category: "buttons", subcategory: "Destructive", description: "Destructive standard button", render: () => <DestructiveStandard forcedState="default" label="Button" /> },
  // Other components

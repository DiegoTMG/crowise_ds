...
const componentCards: CardItem[] = [
  ...
  { name: "PrimarySplitRound", category: "buttons", subcategory: "Primary", description: "Split action primary rounded button", render: () => <PrimarySplitRoundAtom forcedState="default" label="Button" /> },
  // Secondary
  ...
  { name: "SecondarySplitSquare", category: "buttons", subcategory: "Secondary", description: "Split action secondary square button", render: () => <SecondarySplitSquareAtom forcedState="default" label="Button" /> },
  // Tertiary
  ...
  { name: "TertiarySplitSquare", category: "buttons", subcategory: "Tertiary", description: "Split action tertiary square button", render: () => <TertiarySplitSquareAtom forcedState="default" label="Button" /> },

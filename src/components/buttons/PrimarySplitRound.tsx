...
// ─── SVG path constants (identical across all Figma state files) ──────────────
// Plus icon  — viewBox 0 0 11.6667 11.6667
const PLUS_PATH =
  "M11.6667 6.66667H6.66667V11.6667H5V6.66667H0V5H5V0H6.66667V5H11.6667V6.66667Z";
// Chevron    — viewBox 0 0 12 7.41
  ...
  return (
    <div style={{ position: "relative", flexShrink: 0, width: "24px", height: "24px" }}>
      <div
        style={{
          position: "absolute",
          bottom: "34.55%", left: "25%", right: "25%", top: "34.57%",
        }}
      >
        <svg
          style={{ position: "absolute", display: "block", width: "100%", height: "100%" }}
